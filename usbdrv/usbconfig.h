 ...
 */
#define USB_CFG_VENDOR_NAME     'k', 'a', 'l', 'i', 'l', 'a', 'b', 's'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'f', 'o', 'o', 't', 's', 'w', 'i', 't', 'c', 'h'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH   35  /* total length of the report descriptor */ 
